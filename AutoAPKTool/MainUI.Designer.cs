namespace AutoAPKTool
{
	partial class MainUI
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnManifestOnly = new System.Windows.Forms.Button();
			this.修复工具缓存ToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.open_path.Size = new System.Drawing.Size(396, 35);
			...
			this.btn_Decompiler.Location = new System.Drawing.Point(12, 76);
			this.btn_Decompiler.Margin = new System.Windows.Forms.Padding(6);
			this.btn_Decompiler.Name = "btn_Decompiler";
			this.btn_Decompiler.Size = new System.Drawing.Size(107, 33);
			...
			this.btn_SignAPK.Location = new System.Drawing.Point(308, 74);
			...
			this.btn_BuildAndSign.Location = new System.Drawing.Point(176, 74);
			...
			this.btn_dex2jar.Location = new System.Drawing.Point(176, 118);
			...
			this.btn_JdGUI.Location = new System.Drawing.Point(357, 0);
			...
			this.btn_openFile.Location = new System.Drawing.Point(461, 35);
			...
			this.Log.Size = new System.Drawing.Size(571, 301);
			...
			this.btn_decompileDex.Location = new System.Drawing.Point(12, 157);
			this.btn_decompileDex.Name = "btn_decompileDex";
			this.btn_decompileDex.Size = new System.Drawing.Size(107, 33);
			...
			this.btn_compileDex.Location = new System.Drawing.Point(176, 162);
			...
			this.btn_env.Location = new System.Drawing.Point(308, 162);
			...
			this.my_sign.Location = new System.Drawing.Point(435, 74);
			...
			this.dec_odex.Location = new System.Drawing.Point(435, 118);
			...
			this.getArgs.Location = new System.Drawing.Point(435, 162);
			...
			this.menu.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.配置ToolStripMenuItem, this.arm转机器码ToolStripMenuItem, this.打开jadxToolStripMenuItem, this.关于ToolStripMenuItem });
			this.menu.Location = new System.Drawing.Point(0, 0);
			this.menu.Name = "menu";
			this.menu.Size = new System.Drawing.Size(595, 32);
			this.menu.TabIndex = 19;
			this.menu.Text = "配置";
			// 
			// 配置ToolStripMenuItem
			// 
			this.配置ToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.签名ToolStripMenuItem, this.修复工具缓存ToolStripMenuItem });
			...
			this.签名ToolStripMenuItem.Size = new System.Drawing.Size(188, 28);
			this.签名ToolStripMenuItem.Text = "签名配置";
			this.签名ToolStripMenuItem.Click += new System.EventHandler(this.签名ToolStripMenuItemClick);

			this.修复工具缓存ToolStripMenuItem.Name = "修复工具缓存ToolStripMenuItem";
			this.修复工具缓存ToolStripMenuItem.Click += new System.EventHandler(this.修复工具缓存ToolStripMenuItemClick);
			// 
			// arm转机器码ToolStripMenuItem
			// 
			this.arm转机器码ToolStripMenuItem.Name = "arm转机器码ToolStripMenuItem";
			this.arm转机器码ToolStripMenuItem.Size = new System.Drawing.Size(131, 28);
			...
			this.打开jadxToolStripMenuItem.Size = new System.Drawing.Size(94, 28);
			this.打开jadxToolStripMenuItem.Text = "打开jadx";
			this.打开jadxToolStripMenuItem.Click += new System.EventHandler(this.openJadx_Click);
			// 
			// 关于ToolStripMenuItem
			// 
			this.关于ToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.博客ToolStripMenuItem, this.吾爱破解ToolStripMenuItem, this.OpenSourceUrl });
			...
			this.博客ToolStripMenuItem.Size = new System.Drawing.Size(152, 28);
			...
			this.吾爱破解ToolStripMenuItem.Size = new System.Drawing.Size(152, 28);
			...
			this.OpenSourceUrl.Size = new System.Drawing.Size(152, 28);
			this.OpenSourceUrl.Text = "开源地址";
			this.OpenSourceUrl.Click += new System.EventHandler(this.OpenSourceUrl_Click);
			// 
			// btnManifestOnly
			// 
			this.btnManifestOnly.Font = new System.Drawing.Font("微软雅黑", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
			this.btnManifestOnly.Location = new System.Drawing.Point(12, 118);
			...
			// 
			// 修复工具缓存ToolStripMenuItem
			// 
			this.修复工具缓存ToolStripMenuItem.Name = "修复工具缓存ToolStripMenuItem";
			this.修复工具缓存ToolStripMenuItem.Size = new System.Drawing.Size(188, 28);
			this.修复工具缓存ToolStripMenuItem.Text = "修复工具缓存";
			// 
			// MainUI
			// 
			this.AllowDrop = true;
			...
			this.Controls.Add(this.btnManifestOnly);
		...
		private System.Windows.Forms.ToolStripMenuItem 修复工具缓存ToolStripMenuItem;
        
        private System.Windows.Forms.ToolStripMenuItem OpenSourceUrl;
        private System.Windows.Forms.Button btnManifestOnly;
    }
}
